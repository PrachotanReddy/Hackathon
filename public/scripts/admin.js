const destinations = ["announcement", "participant", "scoring"]
...
function deleteUserDetails(email) {
    ...
    fetch(url)
        ...
        .then(function (data) {
            if (data === "done") {
                document.getElementById("alertHolder").innerHTML = `<div class="alert alert-danger" role="alert">
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (let i = recievedData.length - 1; i >= 0; i--) {
                ...
                document.getElementById("announcement-holder").innerHTML += announceContent;
            }
        }
    };
