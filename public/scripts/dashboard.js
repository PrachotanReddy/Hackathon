...
function changeTab(id) {
  ...
  document.getElementById("deletion-toggle").classList.remove("active");
  ...
  for (let i = 0; i < destinations.length; i++) {
    if (destinations[i] == redirectDestination) {
      ...
      document
        .getElementById(`${sidebarLinkSelection}`)
...
async function renderProblems() {
  document.getElementById("problem-placeholder").innerHTML = "";
